...
contract Genesis {
    ...
    struct statsStruct {
        ...
        uint totalBacking;
        uint totalDonations;
        uint validedProjects;
        uint nonValidateProjects;
    }
    ...
    modifier validatorOnly() {
        require(
            ...
            "Hanya validator yang dapat mengakses fungsi ini"
        );
        _;
    }
    ...
    constructor(uint _projectTax, string memory _validatorName) {
        owner = msg.sender;
    ...
    function changeValidator(
        ...
        require(
            ...
            "New validator address cannot be empty"
        );
        require(
            bytes(_validatorName).length > 0,
    ...
    function validateProject(
        ...
        require(msg.sender == validator, "Unauthorized Entity");
        require(
